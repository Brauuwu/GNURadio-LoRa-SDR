...
import threading
import tx_rx_functionality_check_epy_block_0 as epy_block_0  # embedded python block
...
class tx_rx_functionality_check(gr.top_block):
    ...
    def __init__(self):
        ...
        self.lora_sdr_data_source_0 = lora_sdr.data_source(255, 490)
        ...
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.intern("Hello: 0"), 1000)
        self.blocks_message_debug_0_0 = blocks.message_debug(True, gr.log_levels.info)
        self.blocks_message_debug_0 = blocks.message_debug(True, gr.log_levels.info)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/brau/LoRaSDR/Text_Output/text.txt', True)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.blocks_message_strobe_0, 'strobe'), (self.lora_sdr_data_source_0, 'trigg'))
        ...
        self.msg_connect((self.lora_sdr_data_source_0, 'msg'), (self.blocks_message_debug_0_0, 'print'))

...
import Scanner_epy_block_0 as epy_block_0  # embedded python block
import Scanner_epy_block_1 as epy_block_1  # embedded python block
...
class Scanner(gr.top_block):
    ...
    def __init__(self):
        ...
        self.cr = cr = 2
        self.center_freq_0 = center_freq_0 = 433000000
        ...
        self.lora_sdr_whitening_0 = lora_sdr.whitening(False,False,'\n','packet_len')
        ...
        self.iio_pluto_source_0 = iio.fmcomms2_source_fc32('usb:1.5.5' if 'usb:1.5.5' else iio.get_pluto_uri(), [True, True], 32768)
        ...
        self.iio_pluto_sink_1 = iio.fmcomms2_sink_fc32('usb:1.5.5' if 'usb:1.5.5' else iio.get_pluto_uri(), [True, True], 32768, False)
        self.iio_pluto_sink_1.set_len_tag_key('')
        self.iio_pluto_sink_1.set_bandwidth(20000000)
        self.iio_pluto_sink_1.set_frequency(center_freq_0)
        ...
        self.epy_block_1 = epy_block_1.mqtt_subscriber(host='127.0.0.1', port=1883, username='root', password='1', topic='data/input', buf_len=1024, max_len=255)
        self.epy_block_0 = epy_block_0.mqtt_publisher(host='127.0.0.1', port=1883, username='root', password='1', topic='data/output')
        ...
        self.connect((self.epy_block_1, 0), (self.lora_sdr_whitening_0, 0))
        self.connect((self.iio_pluto_source_0, 0), (self.lora_sdr_frame_sync_0, 0))
        self.connect((self.lora_sdr_add_crc_0, 0), (self.lora_sdr_hamming_enc_0, 0))
        self.connect((self.lora_sdr_crc_verif_0, 0), (self.epy_block_0, 0))
        ...
        self.connect((self.lora_sdr_modulate_0, 0), (self.iio_pluto_sink_1, 0))
    ...
    def set_center_freq_0(self, center_freq_0):
        ...
        self.iio_pluto_sink_1.set_frequency(self.center_freq_0)

...
class SDR2(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "SDR2", catch_exceptions=True)
        ...
        self.cr = cr = 1
        self.center_freq_0 = center_freq_0 = 2000000000
        ...
        self.iio_pluto_sink_1 = iio.fmcomms2_sink_fc32('usb:1.6.5' if 'usb:1.6.5' else iio.get_pluto_uri(), [True, True], 32768, False)
...
def main(top_block_cls=SDR2, options=None):
    tb = top_block_cls()

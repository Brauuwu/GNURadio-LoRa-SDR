...
class SDR1(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "SDR1", catch_exceptions=True)
        ...
        self.cr = cr = 1
        self.center_freq_1 = center_freq_1 = 2000000000
        ...
        self.iio_pluto_source_0.set_frequency(center_freq_1)
        ...
        self.iio_pluto_sink_1.set_frequency(center_freq)
    ...
    def set_center_freq_1(self, center_freq_1):
        ...
        self.iio_pluto_source_0.set_frequency(self.center_freq_1)
    ...
    def set_center_freq(self, center_freq):
        ...
        self.iio_pluto_sink_1.set_frequency(self.center_freq)
...
def main(top_block_cls=SDR1, options=None):
    tb = top_block_cls()
